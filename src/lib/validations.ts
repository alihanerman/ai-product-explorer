...
export const ProductFiltersSchema = z.object({
  ...
  sortBy: z.enum(['price-asc', 'price-desc', 'rating-desc', 'name-asc']).optional(),
...
export const CompareProductsSchema = z.object({
  productIds: z.array(z.string().cuid()).min(2, 'At least 2 products required').max(4, 'Maximum 4 products allowed'),
});
